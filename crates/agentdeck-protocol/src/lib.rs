//! Shared types and wire format for AgentDeck daemon ↔ app communication.
//!
...
mod tests {
    ...
    fn test_daemon_status_json() {
        let status = DaemonStatus {
            ...
            device_name: Some("Agent Deck".to_string()),
        ...
        assert_eq!(parsed.device_name.as_deref(), Some("Agent Deck"));
    }
