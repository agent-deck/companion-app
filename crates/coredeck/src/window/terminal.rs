...
pub enum TerminalAction {
    ...
    HidDisplayUpdate { session: String, task: Option<String>, task2: Option<String>, tabs: Vec<u8>, active: usize },
...
pub struct TerminalWindowState {
    ...
    /// HID device connection state
    pub hid_connected: bool,
    /// Connected device name
    pub device_name: Option<String>,
    /// Connected device firmware version
    pub firmware_version: Option<String>,
    /// Whether the device info popup is open
    pub device_popup_open: bool,
...
impl TerminalWindowState {
    ...
    pub fn render(&mut self) {
        ...
        let mut render_params = RenderParams {
            ...
            device_popup_open: &mut self.device_popup_open,
            active_session_data,
            bookmark_manager,
            selection,
        ...
        egui_glow.run(window, |ctx| {
            ...
            egui::TopBottomPanel::top("tab_bar")
                ...
                .show(ctx, |ui| {
                    render_tab_bar(ui, ctx, &mut render_params, &mut new_actions, need_install_loaders);
                });
            ...
            // Render device info popup
            render_device_popup(
                ctx,
                render_params.device_popup_open,
