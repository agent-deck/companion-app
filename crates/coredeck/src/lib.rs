//! Core Deck Companion App
//!
//! A Rust application that connects Claude Code CLI to the Core Deck macropad display.
//!
//! # Features
//! - Wraps Claude Code CLI in a PTY to monitor its state
//! - Connects to coredeck-daemon via WebSocket for device communication
